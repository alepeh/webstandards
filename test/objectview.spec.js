...
describe('stubbing', function () {
  beforeEach(function () {
    ...
    localStorage.setItem("apiurl","http://apiurl");
    ...
    cy.visit('http://localhost:8000/', {
      onBeforeLoad (win) {
        cy.stub(win, 'fetch')
        //.withArgs('http://apiurl/AWS_RDS1/_schema/favorite-fruits')
        .as('fetchFavorites')
  ...
  it('requests favorite fruits', function () {
    cy.visit('http://localhost:8000/#Object');
    // aliasing allows us to easily get access to our stub
    cy.get('@fetchFavorites').should('be.calledWith', 'http://apiurl/AWS_RDS1/_schema')
  })
